...
sur_5 = colon
sur_5['SURVIVAL MONTHS'][sur_5['SURVIVAL MONTHS']<12]=0 #活一年以內
sur_5['SURVIVAL MONTHS'][(sur_5['SURVIVAL MONTHS']>=12)&(sur_5['SURVIVAL MONTHS']<24)]=1 #活一年不超過兩年
sur_5['SURVIVAL MONTHS'][(sur_5['SURVIVAL MONTHS']>=24)&(sur_5['SURVIVAL MONTHS']<36)]=2 #活兩年不超過三年
sur_5['SURVIVAL MONTHS'][(sur_5['SURVIVAL MONTHS']>=36)&(sur_5['SURVIVAL MONTHS']<48)]=3 #活三年不超過四年
sur_5['SURVIVAL MONTHS'][(sur_5['SURVIVAL MONTHS']>=48)&(sur_5['SURVIVAL MONTHS']<60)]=4 #活四年不超過五年
sur_5['SURVIVAL MONTHS'][sur_5['SURVIVAL MONTHS']>=60]=5 #活五年以上
...
for j in dummy_index:
    remain_columns.pop(j) #每一回踢出超過1的欄位
New_columns = remain_columns + dummy_over1_col #排序完成的columns
